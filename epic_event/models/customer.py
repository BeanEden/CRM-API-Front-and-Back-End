...
class Customer(models.Model):
    ...
    first_name = models.CharField(max_length=50,
                                  ...
                                  blank=True)
    last_name = models.CharField(max_length=50, validators=[TEXT_REGEX],
                                 blank=True)
    email = models.EmailField(max_length=100, blank=True)
    phone = models.CharField(max_length=20, validators=[PHONE_REGEX],
                             blank=True)
    mobile = models.CharField(max_length=20, validators=[PHONE_REGEX],
                              blank=True)
    company_name = models.CharField(max_length=200, validators=[TEXT_REGEX],
                                    blank=True)
    date_created = models.DateTimeField(auto_now_add=True)
    date_updated = models.DateTimeField(auto_now=True)
    status = models.CharField(max_length=20, choices=CUSTOMER_STATUS,
                              default=CUSTOMER_STATUS[0][0])
    profile = models.CharField(max_length=20, choices=CUSTOMER_PROFILE,
                               default=CUSTOMER_PROFILE[0][0])
    ...
    def checking_status(self, contract_list):
        """Check and update customer status"""
    ...
    def checking_profile_complete(self):
        """Check if customer profile has a contact option"""
        if not self.email:
