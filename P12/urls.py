...
from epic_event.views.event_view import EventListView, CustomerEventListView, UserEventListView, event_create_view, event_detail_view
...
urlpatterns = [
    ...
    path('user_contract_list/', UserContractListView.as_view(), name='user_contract_list'),
    ...
    path('user_event_list/',UserEventListView.as_view(), name='user_event_list'),
